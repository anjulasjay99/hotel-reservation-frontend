    ...
    return(
     <MKBox component="section" py={12}>
            <div className = "Packages" >
                <h3 style = {{marginLeft : "30px" , marginTop : "30px" , fontWeight :"bold" , fontSize :"25px"}}>Rooms</h3>
                <br/><br/>
                ...
                {rooms.map((room) =>(
                    ...
                    <CardBody className="CardBody">
                        <CardTitle style = {{fontWeight :"bold", fontSize : "18px"}}>{room.title}</CardTitle><br />
