...
function EmployeeHome() {
  ...
  const toAddReservations = () => {
    navigate("/add-reservation-hotel");
  };
  const toViewReservations = () => {
        ...
        <Row>
          <Col>
            ...
            >
              ...
              >
                <div className="home-card-div" onClick={() => toAddReservations()}>
                  <div>
                    <MdPersonAddAlt className="home-card-icon" />
                  </div>
                  <div>
                    <h4>Add Reservations</h4>
                  </div>
                </div>

                <div className="home-card-div" onClick={() => toViewReservations()}>
                  <div>
